...
#define BOARD_NAME "Phil Breakout Board"

#undef EEPROM_ENABLE
#define EEPROM_ENABLE 1

// Define stepper shift pins
#define STEPPER_SHIFT_DATA_PIN      2
#define STEPPER_SHIFT_CLOCK_PIN     3
#define STEPPER_OUTMODE             GPIO_PIO_SHIFT
#define DIRECTION_OUTMODE           GPIO_PIO_SHIFT
#define STEPPERS_DISABLE_OUTMODE    GPIO_PIO_SHIFT
...
#define SPINDLE_OUTMODE       GPIO_MAP
